...
// http://flyingpudding.com/projects/florets/applet/
 ...
 int UIWidth = 1220;
 int vizWidth = 820;
 int displayWidth = vizWidth + UIWidth;
 int displayHeight = vizWidth;
 int UIStartWidth = vizWidth;
 int UIStartHeight = 10;
 int vizStartWidth = 0;
 int vizStartHeight = 0;
 float currentAngle = 0.0;
 // https://pdfs.semanticscholar.org/2eb7/51b5ab8629992e5fe98fbc743cea499ca99f.pdf
 // 1.41421(360), or 1.41421 revolutions, reduced to 0.41421 or 149.2 degrees. 
 float goldenAngle = 137.5; // or 222.5. another irrational number that works well is sqrt(2). 
 int timeLastDrawn = 0;
...
//  stroke(255);
//  line(0, UIStartHeight,displayWidth,UIStartHeight);


  PFont fontA = loadFont("CourierNewPSMT-48.vlw");
...
{  
    ...
    float originY = displayHeight/2.0;
